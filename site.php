...
$usdt = $row['usdt_balance'] ?? 0;

// fetch transactions for this user only
$stmt = $pdo->prepare('SELECT id, type, amount, currency, operator, created_at FROM transactions WHERE user_id = ? ORDER BY created_at DESC');
$stmt->execute([$userId]);
...
<body class="bg-gray-200">
        ...
        <div class="flex justify-between items-center px-9 py-4">
            ...
            <div class="flex items-center space-x-6">
                <span class="text-white text-sm hidden sm:inline">
                    <i class="fas fa-user text-green-400 mr-2"></i><?php echo htmlspecialchars($username); ?>
                </span>
                <a href="logout.php" class="text-red-400 hover:text-red-300 font-semibold text-sm">
    ...
    <!-- Sidebar -->
    <div id="sideNav" class="hidden lg:block lg:fixed lg:left-0 lg:top-0 lg:w-64 lg:h-screen lg:pt-20 bg-white shadow-lg">
        <div class="p-6 space-y-3">
            <a href="site.php" class="block px-4 py-3 rounded-lg text-white bg-gradient-to-r from-green-900 to-green-400 font-medium hover:shadow-lg transition">
                <i class="fas fa-home mr-3"></i>Accueil
            </a>
            <a href="account.php" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition">
                <i class="fas fa-user mr-3"></i>Mon compte
            </a>
            <a href="logs.php" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition">
                <i class="fas fa-file-alt mr-3"></i>Logs d'activité
            </a>
            <hr class="my-3">
            <a href="depot.php" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-green-50 transition">
                <i class="fas fa-plus-circle text-green-600 mr-3"></i>Effectuer un dépôt
            </a>
            <a href="retrait.php" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-red-50 transition">
                <i class="fas fa-minus-circle text-red-600 mr-3"></i>Effectuer un retrait
            </a>
            <a href="convert.php" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-blue-50 transition">
                <i class="fas fa-exchange-alt text-blue-600 mr-3"></i>Convertir en USDT
            </a>
            <hr class="my-3">
            <a href="logout.php" class="block px-4 py-3 rounded-lg text-red-600 hover:bg-red-50 font-semibold transition">
    ...
    <div class="lg:ml-64 p-4 lg:p-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-green-500">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h2 class="text-4xl font-bold text-green-600"><?php echo number_format($balance, 2); ?></h2>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-500">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h2 class="text-4xl font-bold text-blue-600"><?php echo number_format($usdt, 4); ?></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <!-- Dépôt -->
            <a href="depot.php" class="bg-gradient-to-br from-green-900 to-green-500 p-6 rounded-lg shadow-md hover:shadow-xl transition transform hover:scale-105 text-white text-center">
            ...
            <!-- Retrait -->
            <a href="retrait.php" class="bg-gradient-to-br from-red-900 to-red-500 p-6 rounded-lg shadow-md hover:shadow-xl transition transform hover:scale-105 text-white text-center">
            ...
            <!-- Convertir -->
            <a href="convert.php" class="bg-gradient-to-br from-blue-900 to-blue-500 p-6 rounded-lg shadow-md hover:shadow-xl transition transform hover:scale-105 text-white text-center">
            ...
            <!-- Historique -->
            <a href="logs.php" class="bg-gradient-to-br from-gray-800 to-gray-600 p-6 rounded-lg shadow-md hover:shadow-xl transition transform hover:scale-105 text-white text-center">
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-100 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Opérateur</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            ?>
                                <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-700"><?php echo htmlspecialchars($t['operator'] ?? '-'); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
