...
<body>
    <div class="bg-white-200 flex">
        <div class="flex-col flex ml-auto mr-auto items-center w-full lg:w-2/3 md:w-3/5">
            ...
            <form action="/login" method="post" class="mt-2 flex flex-col lg:w-1/2 w-8/12">
                <?php if ($message): ?>
                ...
                <div class="flex flex-wrap items-stretch w-full mb-4 relative h-15 bg-white items-center rounded mb-6 pr-10">
                    ...
                    <input name="username" type="text" class="flex-shrink flex-grow flex-auto leading-normal w-px flex-1 h-10 border border-gray-400 rounded rounded-l-none px-3 self-center relative font-roboto text-xl outline-none" placeholder="Nom d'utilisateur" />
                </div>
                <div class="flex flex-wrap items-stretch w-full relative h-15 bg-white items-center rounded mb-4">
                    ...
                    <input name="password" type="password" class="flex-shrink flex-grow flex-auto leading-normal w-px flex-1 h-10 border border-gray-400 rounded rounded-l-none px-3 self-center relative font-roboto text-xl outline-none" placeholder="mot de passe" />
                ...
                <button type="submit" class="bg-[#006400] py-4 text-center px-17 md:px-12 md:py-4 text-white rounded leading-tight text-xl md:text-base font-sans mt-4 mb-20">
                    Connexion
                </button>
            </form>
            <p class="text-center">Pas de compte ? <a href="/register" class="text-blue-500">S'inscrire</a></p>
        </div>
    </div>
</body>
</html>